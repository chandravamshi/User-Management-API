...
import { LoginUserResponse, RegisterUserResponse } from '../interfaces/responseInterfaces';
...
export class UserController {
  ...
  @Post('/login')
  @UseAfter(ValidationErrors)
  async login(@Body() user: User, @Res() response: Response<LoginUserResponse>): Promise<Response> {
